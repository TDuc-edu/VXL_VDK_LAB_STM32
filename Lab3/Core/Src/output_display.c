...
/* Init -----*/
/* LED Pin */
uint16_t LED[NO_LED] = {RED1_Pin, YELLOW1_Pin, GREEN1_Pin,
...
void updateBuffer(void) {
  SEG_buffer[0] = time_road1 / 10;
  SEG_buffer[1] = time_road1 % 10;
  SEG_buffer[2] = time_road2 / 10;
  SEG_buffer[3] = time_road2 % 10;
}
/* 7SEG LED control */
