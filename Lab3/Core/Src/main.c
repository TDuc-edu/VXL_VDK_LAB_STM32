...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED7SEG_0_Pin|LED7SEG_1_Pin|LED7SEG_2_Pin|BUTTON_2_Pin
                          |LED7SEG_3_Pin|LED7SEG_4_Pin|LED7SEG_5_Pin|LED7SEG_6_Pin
                          |BUTTON_0_Pin|BUTTON_1_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LED7SEG_0_Pin|LED7SEG_1_Pin|LED7SEG_2_Pin|BUTTON_2_Pin
                          |LED7SEG_3_Pin|LED7SEG_4_Pin|LED7SEG_5_Pin|LED7SEG_6_Pin
                          |BUTTON_0_Pin|BUTTON_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
